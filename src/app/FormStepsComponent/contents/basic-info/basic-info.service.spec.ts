  ...
  describe('searchContratos', () => {
    it('should search contratos with correct parameters and update observables', () => {
      ...
      const req = httpMock.expectOne((request) => {
        return request.url === '/api/contratos' &&
    ...
    it('should handle loading more data (page > 1) with same filters', () => {
      ...
      req2.flush({
        data: [{ id: '3', chave: 'CHAVE003', operacao: 'OP003', vinculoTrade: 'VT003', acao: 'COMPRA' }],
        total: 3,
        page: 2,
        pageSize: 12
      });
    ...
    it('should reset data when filters change', () => {
      ...
      req2.flush({
        data: [{ id: '3', chave: 'CHAVE003', operacao: 'OP003', vinculoTrade: 'VT003', acao: 'VENDA' }],
        total: 1,
        page: 1,
        pageSize: 12
      });
